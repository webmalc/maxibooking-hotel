 ...
 */
class MBHBundleClientBundleDocumentDocumentTemplateHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        if (isset($data['orientation'])) {
            ...
            $return = (string) $value;
            $this->class->reflFields['orientation']->setValue($document, $return);
            $hydratedData['orientation'] = $return;
        }
