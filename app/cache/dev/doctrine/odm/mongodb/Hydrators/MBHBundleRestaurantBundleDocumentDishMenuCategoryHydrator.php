 ...
 */
class MBHBundleRestaurantBundleDocumentDishMenuCategoryHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        /** @Many */
        $mongoData = isset($data['dishMenuItems']) ? $data['dishMenuItems'] : null;
        $return = new \Doctrine\ODM\MongoDB\PersistentCollection(new \Doctrine\Common\Collections\ArrayCollection(), $this->dm, $this->unitOfWork);
        $return->setHints($hints);
        $return->setOwner($document, $this->class->fieldMappings['dishMenuItems']);
        $return->setInitialized(false);
        if ($mongoData) {
            $return->setMongoData($mongoData);
        }
        $this->class->reflFields['dishMenuItems']->setValue($document, $return);
        $hydratedData['dishMenuItems'] = $return;
