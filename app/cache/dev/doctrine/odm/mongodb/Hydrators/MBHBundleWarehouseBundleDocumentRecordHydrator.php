 ...
 */
class MBHBundleWarehouseBundleDocumentRecordHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        if (isset($data['recordDate'])) {
            ...
            $this->class->reflFields['recordDate']->setValue($document, clone $return);
            $hydratedData['recordDate'] = $return;
        }
        ...
        if (isset($data['qtty'])) {
            $value = $data['qtty'];
            $return = (float) $value;
            $this->class->reflFields['qtty']->setValue($document, $return);
            $hydratedData['qtty'] = $return;
        }
