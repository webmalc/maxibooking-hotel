 ...
 */
class MBHBundleChannelManagerBundleDocumentMyallocatorConfigHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        /** @Field(type="float") */
        if (isset($data['currencyDefaultRatio'])) {
            $value = $data['currencyDefaultRatio'];
            $return = (float) $value;
            $this->class->reflFields['currencyDefaultRatio']->setValue($document, $return);
            $hydratedData['currencyDefaultRatio'] = $return;
        }
