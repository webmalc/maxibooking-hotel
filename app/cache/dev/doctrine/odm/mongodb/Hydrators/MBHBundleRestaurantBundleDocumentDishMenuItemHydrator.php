 ...
 */
class MBHBundleRestaurantBundleDocumentDishMenuItemHydrator implements HydratorInterface
{
    private $dm;
    private $unitOfWork;
    private $class;
    ...
    public function hydrate($document, $data, array $hints = array())
    {
        ...
        if (isset($data['margin'])) {
            $value = $data['margin'];
            $return = (float) $value;
            $this->class->reflFields['margin']->setValue($document, $return);
            $hydratedData['margin'] = $return;
        }

        /** @Field(type="boolean") */
        if (isset($data['isMargin'])) {
            $value = $data['isMargin'];
            $return = (bool) $value;
            $this->class->reflFields['isMargin']->setValue($document, $return);
            $hydratedData['isMargin'] = $return;
        }
        ...
        /** @Many */
        $mongoData = isset($data['dishIngredients']) ? $data['dishIngredients'] : null;
        $return = new \Doctrine\ODM\MongoDB\PersistentCollection(new \Doctrine\Common\Collections\ArrayCollection(), $this->dm, $this->unitOfWork);
        $return->setHints($hints);
        $return->setOwner($document, $this->class->fieldMappings['dishIngredients']);
        $return->setInitialized(false);
        if ($mongoData) {
            $return->setMongoData($mongoData);
        }
        $this->class->reflFields['dishIngredients']->setValue($document, $return);
        $hydratedData['dishIngredients'] = $return;
