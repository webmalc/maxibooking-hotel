 ...
 */
class Service extends \MBH\Bundle\ChannelManagerBundle\Document\Service implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'service', 'serviceId'];
        }
