 ...
 */
class VegaFMS extends \MBH\Bundle\VegaBundle\Document\VegaFMS implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'code', 'name', 'originalName', 'id', 'isEnabled'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VegaFMS $proxy) {
