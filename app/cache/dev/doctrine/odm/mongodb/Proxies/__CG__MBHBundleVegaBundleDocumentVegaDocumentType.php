 ...
 */
class VegaDocumentType extends \MBH\Bundle\VegaBundle\Document\VegaDocumentType implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'originalName', 'code', 'id', 'isEnabled'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VegaDocumentType $proxy) {
