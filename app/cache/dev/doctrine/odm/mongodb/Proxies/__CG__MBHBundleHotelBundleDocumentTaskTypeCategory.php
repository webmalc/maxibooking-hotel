 ...
 */
class TaskTypeCategory extends \MBH\Bundle\HotelBundle\Document\TaskTypeCategory implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'title', 'fullTitle', 'isSystem', 'code', 'types', 'id', 'isEnabled', 'createdAt', 'updatedAt', 'deletedAt', 'createdBy', 'updatedBy', 'hotel'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaskTypeCategory $proxy) {
