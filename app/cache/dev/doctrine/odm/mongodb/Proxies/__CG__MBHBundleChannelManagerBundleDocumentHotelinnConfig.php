 ...
 */
class HotelinnConfig extends \MBH\Bundle\ChannelManagerBundle\Document\HotelinnConfig implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HotelinnConfig $proxy) {
