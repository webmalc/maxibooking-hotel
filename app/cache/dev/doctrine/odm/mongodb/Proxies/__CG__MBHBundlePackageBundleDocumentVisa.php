 ...
 */
class Visa extends \MBH\Bundle\PackageBundle\Document\Visa implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'type', 'series', 'number', 'issued', 'expiry', 'profession', 'arrivalTime', 'departureTime', 'id', 'isEnabled'];
        }
