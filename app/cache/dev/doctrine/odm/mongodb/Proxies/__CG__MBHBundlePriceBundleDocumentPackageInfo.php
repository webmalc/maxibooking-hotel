 ...
 */
class PackageInfo extends \MBH\Bundle\PriceBundle\Document\PackageInfo implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'tariff', 'packagesCount'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PackageInfo $proxy) {
    ...
    public function sold()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'sold', []);
