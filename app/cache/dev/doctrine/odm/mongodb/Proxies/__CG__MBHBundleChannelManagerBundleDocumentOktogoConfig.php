 ...
 */
class OktogoConfig extends \MBH\Bundle\ChannelManagerBundle\Document\OktogoConfig implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'hotel', 'rooms', 'tariffs', 'enabled', 'login', 'username', 'password', 'id', 'isEnabled', 'createdAt', 'updatedAt', 'deletedAt', 'createdBy', 'updatedBy'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OktogoConfig $proxy) {
