 ...
 */
class IngredientCategory extends \MBH\Bundle\RestaurantBundle\Document\IngredientCategory implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'fullTitle', 'title', 'hotel', 'ingredients', 'id', 'isEnabled', 'createdAt', 'updatedAt', 'deletedAt', 'createdBy', 'updatedBy'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (IngredientCategory $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addIngredient(\MBH\Bundle\RestaurantBundle\Document\Ingredient $ingredient)
    {
     ...
     * {@inheritDoc}
     */
    public function removeIngredient(\MBH\Bundle\RestaurantBundle\Document\Ingredient $ingredient)
    {
