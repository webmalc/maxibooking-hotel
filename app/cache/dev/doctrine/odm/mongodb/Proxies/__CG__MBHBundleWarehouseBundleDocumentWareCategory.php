 ...
 */
class WareCategory extends \MBH\Bundle\WarehouseBundle\Document\WareCategory implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MBH\\Bundle\\WarehouseBundle\\Document\\WareCategory' . "\0" . 'items', '' . "\0" . 'MBH\\Bundle\\WarehouseBundle\\Document\\WareCategory' . "\0" . 'fullTitle', '' . "\0" . 'MBH\\Bundle\\WarehouseBundle\\Document\\WareCategory' . "\0" . 'title', '' . "\0" . 'MBH\\Bundle\\WarehouseBundle\\Document\\WareCategory' . "\0" . 'system', 'id', 'isEnabled', 'createdAt', 'updatedAt', 'deletedAt', 'createdBy', 'updatedBy'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WareCategory $proxy) {
