 ...
 */
class PollQuestion extends \MBH\Bundle\PackageBundle\Document\PollQuestion implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'sort', 'text', 'category'];
        }
