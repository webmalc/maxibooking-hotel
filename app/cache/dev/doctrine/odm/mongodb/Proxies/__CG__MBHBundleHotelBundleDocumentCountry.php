 ...
 */
class Country extends \MBH\Bundle\HotelBundle\Document\Country implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'regions', 'cities', 'title', '' . "\0" . 'MBH\\Bundle\\HotelBundle\\Document\\Country' . "\0" . 'locale', 'id', 'isEnabled', 'createdAt', 'updatedAt', 'deletedAt', 'createdBy', 'updatedBy'];
        }
