 ...
 */
class Room extends \MBH\Bundle\ChannelManagerBundle\Document\Room implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'roomType', 'roomId'];
        }
    ...
    public function setRoomId($roomId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRoomId', [$roomId]);
    ...
    public function getRoomId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRoomId', []);
