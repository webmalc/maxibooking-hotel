 ...
 */
class ServiceCategory extends \MBH\Bundle\PriceBundle\Document\ServiceCategory implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'services', 'hotel', 'fullTitle', 'title', 'description', 'system', 'id', 'isEnabled', 'createdAt', 'updatedAt', 'deletedAt', 'createdBy', 'updatedBy'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ServiceCategory $proxy) {
