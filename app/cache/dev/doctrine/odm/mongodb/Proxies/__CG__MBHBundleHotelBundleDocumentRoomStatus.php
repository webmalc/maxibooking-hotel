 ...
 */
class RoomStatus extends \MBH\Bundle\HotelBundle\Document\RoomStatus implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['code' => NULL, 'title' => NULL];
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'code', 'title', 'id', 'isEnabled', 'createdAt', 'updatedAt', 'deletedAt', 'createdBy', 'updatedBy', 'hotel'];
        }

        return ['__isInitialized__', 'id', 'isEnabled', 'createdAt', 'updatedAt', 'deletedAt', 'createdBy', 'updatedBy', 'hotel'];
    }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RoomStatus $proxy) {
