 ...
 */
class CreditCard extends \MBH\Bundle\PackageBundle\Document\CreditCard implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = ['type' => NULL, 'number' => NULL, 'cardholder' => NULL, 'date' => NULL, 'cvc' => NULL];
    ...
    {
        unset($this->type, $this->number, $this->cardholder, $this->date, $this->cvc);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'type', 'number', 'cardholder', 'date', 'cvc'];
        }
    ...
    public function encrypt($plaintext)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'encrypt', [$plaintext]);
    ...
    public function decrypt($ciphertext)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'decrypt', [$ciphertext]);
    ...
    public function encryptAll()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'encryptAll', []);

        return parent::encryptAll();
    }
