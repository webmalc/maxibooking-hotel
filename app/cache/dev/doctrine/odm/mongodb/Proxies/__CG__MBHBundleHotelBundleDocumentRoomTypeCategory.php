 ...
 */
class RoomTypeCategory extends \MBH\Bundle\HotelBundle\Document\RoomTypeCategory implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'hotel', 'fullTitle', 'title', 'description', 'types', 'id', 'isEnabled', 'createdAt', 'updatedAt', 'deletedAt', 'createdBy', 'updatedBy', 'isChildPrices', 'isIndividualAdditionalPrices'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RoomTypeCategory $proxy) {
