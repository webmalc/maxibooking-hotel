 ...
 */
class VegaRegion extends \MBH\Bundle\VegaBundle\Document\VegaRegion implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VegaRegion $proxy) {
