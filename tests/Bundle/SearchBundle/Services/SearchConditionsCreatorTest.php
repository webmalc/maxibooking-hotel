...
class SearchConditionsCreatorTest extends WebTestCase
{
    ...
    {
        $this->receiver = $this->getContainer()->get('mbh_search.search_condition_creater');
    ...
    public function testHandleSuccessData1(): void
    {
        ...
        $result = $this->receiver->createSearchConditions($data);
    ...
    {
        $result = $this->receiver->createSearchConditions($data['raw']);
    ...
    public function testHandleFail($data): void
    {
        ...
        $this->receiver->createSearchConditions($data);
    }
