...
class ProfileControllerTest extends WebTestCase
{
    ...
    private const USER_ADMIN_ID = '5a993220cb5f740de15d9652';
    ...
    {
        $user =  $this->dm->getRepository('MBHUserBundle:User')->find(self::USER_ADMIN_ID);
    ...
    public function testChangePassAnotherUser()
    {
        $this->client = self::createClient(
            [],
            [
