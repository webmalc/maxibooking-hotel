...
class VashotelConfig extends Base implements BaseInterface
{
    ...
    /**
     * @var array
     * @ODM\EmbedMany(targetDocument="VashotelRoom")
     */
    protected $rooms;

    /**
     * @var array
     * @ODM\EmbedMany(targetDocument="VashotelTariff")
     */
    protected $tariffs;
     ...
     * Add room
     *
     * @param \MBH\Bundle\ChannelManagerBundle\Document\VashotelRoom $room
     */
    public function addRoom(\MBH\Bundle\ChannelManagerBundle\Document\VashotelRoom $room)
    {
        $this->rooms[] = $room;
    }
     ...
     * @param \MBH\Bundle\ChannelManagerBundle\Document\VashotelRoom $room
     */
    public function removeRoom(\MBH\Bundle\ChannelManagerBundle\Document\VashotelRoom $room)
    {
     ...
     * Add tariff
     *
     * @param \MBH\Bundle\ChannelManagerBundle\Document\VashotelTariff $tariff
     */
    public function addTariff(\MBH\Bundle\ChannelManagerBundle\Document\VashotelTariff $tariff)
    {
        $this->tariffs[] = $tariff;
    }
     ...
     * @param \MBH\Bundle\ChannelManagerBundle\Document\VashotelTariff $tariff
     */
    public function removeTariff(\MBH\Bundle\ChannelManagerBundle\Document\VashotelTariff $tariff)
    {
