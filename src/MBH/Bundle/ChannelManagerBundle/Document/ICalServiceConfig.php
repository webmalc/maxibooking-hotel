...
abstract class ICalServiceConfig extends Base implements ChannelManagerConfigInterface
{
    use ConfigTrait;
     ...
     * @ODM\EmbedMany(targetDocument="ICalServiceRoom")
     */
    protected $rooms;
    ...
    /**
     * @return ArrayCollection|array|ICalServiceRoom[]
     */
     ...
     * @return static
     */
    public function setIsRoomLinksPageViewed(bool $isRoomLinksPageViewed): self
    {
     ...
     * @return ICalServiceRoom|mixed|null
     */
