...
class Booking extends Base
{
    ...
    public function pullOrders()
    {
        ...
        foreach ($this->getConfig() as $config) {
            ...
            $request = $this->templating->render('MBHChannelManagerBundle:Booking:reservations.xml.twig',
    ...
    private function createPackage(
        ...
        foreach ($reservation->room as $room) {
            ...
            if ($payer->getFirstName().' '.$payer->getLastName() == (string)$room->guest_name) {
                ...
                $guest = $this->dm->getRepository('MBHPackageBundle:Tourist')->fetchOrCreate('н/д',
    ...
    public function updateRooms(\DateTime $begin = null, \DateTime $end = null, RoomType $roomType = null)
    {
        ...
        foreach ($this->getConfig() as $config) {
            ...
            $request = $this->templating->render('MBHChannelManagerBundle:Booking:updateRooms.xml.twig',
                ['config' => $config, 'params' => $this->params, 'data' => $data]);
    ...
    public function updatePrices(\DateTime $begin = null, \DateTime $end = null, RoomType $roomType = null)
    {
        ...
        foreach ($this->getConfig() as $config) {
            ...
            $request = $this->templating->render('MBHChannelManagerBundle:Booking:updatePrices.xml.twig',
                ['config' => $config, 'params' => $this->params, 'data' => $data]);
            $sendResult = $this->send(static::BASE_URL.'availability', $request, null, true);
            $result = $this->checkResponse($sendResult);
        }
    ...
    public function updateRestrictions(\DateTime $begin = null, \DateTime $end = null, RoomType $roomType = null)
    {
        ...
        foreach ($this->getConfig() as $config) {
            ...
            $request = $this->templating->render('MBHChannelManagerBundle:Booking:updateRestrictions.xml.twig',
                ['config' => $config, 'params' => $this->params, 'data' => $data]);
    ...
    {
        $result = [];
        $request = $this->templating->render('MBHChannelManagerBundle:Booking:get.xml.twig',
