...
//        $hotelId = $request->get('partner_hotel_code');
    ...
    {
        $basePath = $this->get('kernel')->getRootDir() . '/../src/MBH/Bundle/HotelBundle/Resources/csv/';
        ...
        $regions = $this->getCities($filesPaths['city']);

        $yandexTranslator = $this->get('mbh.yandex_translator');
        ...
        $this->writeTranslatedValues($translatedValues, $filesPaths['city']);

        return new Response();
    }

    private function getCities($filePath)
    {
