...
class InvoiceController extends Controller
{
    ...
    public function createAction(Request $request)
    {
		...
		if ($form->isSubmitted() && $form->isValid()) {
            ...
            $request->getSession()->getFlashBag()->set('success', $this->container->get('translator')->trans('warehouse.controller.invoicecontroller.new_consignment_note_has_been_created_successfully'));
    ...
    public function updateAction(Request $request, Invoice $entity) {
        ...
        if ($form->isValid()) {
            ...
            $request->getSession()->getFlashBag()->set('success', $this->container->get('translator')->trans('warehouse.controller.invoicecontroller.consignment_saved'));
