...
class SpecialType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('beginOffset', NumberType::class, [
                'label' => 'special.beginOffset',
                'group' => 'special.group.dates',
                'help' => 'special.beginOffset.help',
            ...
            ->add('endOffset', NumberType::class, [
                'label' => 'special.endOffset',
                'group' => 'special.group.dates',
                'help' => 'special.endOffset.help',
                'attr' => ['class' => 'spinner-0'],
            ])
