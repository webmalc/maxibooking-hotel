...
$(document).ready(function () {
    ...
    if ($('.daterangepicker-input').prev().is('#room-cache-overview-filter-begin')) {
        if (!($('#room-cache-overview-filter-begin').val()) && !($('#room-cache-overview-filter-end').val())) {
            ...
            $('#room-cache-overview-filter-begin').val($('.daterangepicker-input').data('daterangepicker').startDate.format('DD.MM.YYYY'));
            $('#room-cache-overview-filter-end').val($('.daterangepicker-input').data('daterangepicker').endDate.format('DD.MM.YYYY'));
        }
    }
