<template>
    <div id="online-booking-search">
        ...
        <p v-if="!searchStatus && !isResultsFounded && !isSearchError">
        ...
        <p v-if="isSearchError">
            Произошла непредвиденная ошибка. Пожалуйста, отключите поиск по гибким датам или попробуйте позже. {{errorMessage}}
        </p>
