...
------|---------|-----------
Webserver|[localhost:9090](http://localhost:9090)|[192.168.33.241](http://192.168.33.241)
...
------|---------|-----------
php-fpm|mbh-php-fpm|9000
Memcached|mbh-memcached|11211 (default)
...
**Note 2:** if you're using Vagrant, you'll need to ssh into it first
  ...
  * Execute command inside of container: `docker exec -it mbh-php-fpm COMMAND` where `COMMAND` is whatever you want to run. For instance, `/bin/bash` to open a console prompt.
